...
window.averta = {},
    ...
    function($) {
        ...
        p.setupView = function() {
            ...
            if (this.view.create(startSlide), 0 === this.so.preload && this.view.slideList[0].loadImages(), this.scroller = this.view.controller, this.so.wheel) {
                ...
                }, window.MSBrowserInfo.mozilla ? this.slider.$element[0].addEventListener("DOMMouseScroll", this.wheellistener) : this.slider.$element.on("mousewheel", this.wheellistener)
            }
    ...
    function($) {
        ...
        }, MasterSlider.author = "Averta Ltd. (www.averta.net)", MasterSlider.version = "2.85.12", MasterSlider.releaseDate = "Sep 2021", MasterSlider._plugins = [];
        var MS = MasterSlider;
